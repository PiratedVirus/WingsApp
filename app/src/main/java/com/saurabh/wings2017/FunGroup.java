...
public class FunGroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fun_group);
        ...
        groupname.setText(SaveSharedPreferences.getUserName(FunGroup.this)+", ");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(FunGroup.this, error.getMessage(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                getUserDetails();
                mobNum = SaveSharedPreferences.getUserPhone(FunGroup.this);
                groupname = (EditText)findViewById(R.id.grouptext);
                String temp = groupname.getText().toString().trim();
                Map<String, String> params = new HashMap<>();
                params.put("fuserName",SaveSharedPreferences.getUserName(FunGroup.this));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(FunGroup.this, Mini.class);
    ...
    public void addcart(View v)
    {
        ...
        if(name.length > Integer.parseInt(xyz))
        {
            ...
            new SweetAlertDialog(FunGroup.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
