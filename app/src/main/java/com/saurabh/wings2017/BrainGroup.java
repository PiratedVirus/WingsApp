...
public class BrainGroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        groupname.setText(SaveSharedPreferences.getUserName(BrainGroup.this)+", ");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(BrainGroup.this, error.getMessage(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                getUserDetails();
                mobNum = SaveSharedPreferences.getUserPhone(BrainGroup.this);
                groupname = (EditText)findViewById(R.id.grouptext);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(BrainGroup.this, Brain.class);
    ...
    public void addcart(View v)
    {
        ...
        else if(groupname.getText().toString().isEmpty())
        {
            ...
            new SweetAlertDialog(BrainGroup.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
