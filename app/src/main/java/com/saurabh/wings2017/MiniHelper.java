...
public class MiniHelper extends AppCompatActivity {
    ...
    public void fetchData(final String price) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                getUserDetails();
                mobNum = SaveSharedPreferences.getUserPhone(MiniHelper.this);
                eventprice = getIntent().getStringExtra("EventCriteria");
                Log.d(TAG, "price: " + eventprice);
                Map<String, String> params = new HashMap<>();
                params.put("fuserName", SaveSharedPreferences.getUserName(MiniHelper.this));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mini_helper);
                        ...
                        new SweetAlertDialog(MiniHelper.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
                                ...
                                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                    ...
                                    public void onClick(SweetAlertDialog sDialog) {
                                        ...
                                        i.putExtra("fuserName", SaveSharedPreferences.getUserName(MiniHelper.this));
