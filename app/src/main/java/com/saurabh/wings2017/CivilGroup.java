...
public class CivilGroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civil_group);
        ...
        groupname.setText(SaveSharedPreferences.getUserName(CivilGroup.this)+", ");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CivilGroup.this, error.getMessage(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                getUserDetails();
                mobNum = SaveSharedPreferences.getUserPhone(CivilGroup.this);
                groupname = (EditText)findViewById(R.id.grouptext);
                String temp = groupname.getText().toString().trim();
                Map<String, String> params = new HashMap<>();
                params.put("fuserName",SaveSharedPreferences.getUserName(CivilGroup.this));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(CivilGroup.this, CivilHome.class);
