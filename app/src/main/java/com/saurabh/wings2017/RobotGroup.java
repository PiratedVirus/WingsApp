...
public class RobotGroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_robot_group);
        ...
        groupname.setText(SaveSharedPreferences.getUserName(RobotGroup.this)+", ");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(RobotGroup.this, error.getMessage(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                getUserDetails();
                mobNum = SaveSharedPreferences.getUserPhone(RobotGroup.this);
                groupname = (EditText)findViewById(R.id.grouptext);
                String temp = groupname.getText().toString().trim();
                Map<String, String> params = new HashMap<>();
                params.put("fuserName", SaveSharedPreferences.getUserName(RobotGroup.this));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(RobotGroup.this, Robotics.class);
    ...
    public void addcart(View v)
    {
        ...
        if(name.length > Integer.parseInt(xyz))
        {
            ...
            new SweetAlertDialog(RobotGroup.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
