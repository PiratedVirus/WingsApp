...
public class MechGroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mech_group);
        ...
        groupname.setText(SaveSharedPreferences.getUserName(MechGroup.this)+", ");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MechGroup.this, error.getMessage(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                getUserDetails();
                mobNum = SaveSharedPreferences.getUserPhone(MechGroup.this);
                groupname = (EditText)findViewById(R.id.grouptext);
                String temp = groupname.getText().toString().trim();
                Map<String, String> params = new HashMap<>();
                params.put("fuserName",SaveSharedPreferences.getUserName(MechGroup.this));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(MechGroup.this, Mechanico.class);
    ...
    public void addcart(View v)
    {
        ...
        else if(groupname.getText().toString().isEmpty())
        {
            ...
            new SweetAlertDialog(MechGroup.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
