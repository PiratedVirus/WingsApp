...
public class CivilEventAdapter extends ArrayAdapter<String> {
    ...
    private final ArrayList background;


    public CivilEventAdapter(Activity context,
                             ArrayList eventName_list, ArrayList eventDetails_list, ArrayList eventLocation, ArrayList eventContactPerson_list, ArrayList eventContactNum_list, ArrayList eventDate, ArrayList background) {
