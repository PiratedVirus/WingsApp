...
public class CivilHelper extends AppCompatActivity {
    ...
    public void fetchData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                getUserDetails();
                mobNum = SaveSharedPreferences.getUserPhone(CivilHelper.this);
                eventprice = getIntent().getStringExtra("EventCriteria");
                Log.d(TAG, "price: " + eventprice);
                Map<String, String> params = new HashMap<>();
                params.put("fuserName", SaveSharedPreferences.getUserName(CivilHelper.this));
                    ...
                    if (Integer.parseInt(member) != 0) {
                        ...
                        new SweetAlertDialog(CivilHelper.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
                                ...
                                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                    @Override
                                    public void onClick(SweetAlertDialog sDialog) {
                                        Intent i = new Intent(getApplicationContext(), CivilGroup.class);
                                        i.putExtra("member", member);
                                        i.putExtra("fuserName",SaveSharedPreferences.getUserName(CivilHelper.this));
...
//                        .setContentText("Events later can be changed through cart.")
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(CivilHelper.this, CivilHome.class);
        startActivity(i);
        finish();
    }
}
