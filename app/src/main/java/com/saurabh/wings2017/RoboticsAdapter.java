...
public class RoboticsAdapter extends ArrayAdapter<String> {
    ...
    public RoboticsAdapter(Activity context,
        ...
        super(context, R.layout.content_robotics_single, eventName_list);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.content_robotics_single, null, true);
        rowView.setMinimumHeight(80);

        RelativeLayout rel = (RelativeLayout) rowView.findViewById(R.id.roboRel);
